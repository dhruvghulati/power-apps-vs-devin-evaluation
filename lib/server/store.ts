  ...
  const flows: Flow[] = [
    {
      ...
      steps: [
        { id: 'stp_1', kind: 'condition', field: 'amountMinor', operator: 'gt', value: '100000' },
        { id: 'stp_2', kind: 'approval', approverRole: 'kyc_approver', slaHours: 8 },
        { id: 'stp_3', kind: 'action', action: 'notify', target: 'financial-crime', message: 'High-value refund awaiting compliance approval.' },
      ],
      status: 'active',
      connectors: [],
    ...
    },
    {
      ...
      steps: [
        { id: 'stp_4', kind: 'condition', field: 'topic', operator: 'contains', value: 'screening' },
        { id: 'stp_5', kind: 'action', action: 'escalate_case', target: 'auto', message: 'Screening hit received from Kafka feed.' },
        { id: 'stp_6', kind: 'action', action: 'notify', target: 'mlro', message: 'Potential sanctions match requires MLRO review.' },
      ],
      status: 'active',
      connectors: ['cnx_8003'],
    ...
    },
    {
      ...
      steps: [
        { id: 'stp_7', kind: 'action', action: 'create_task', target: 'treasury', message: 'Reconcile settled payouts against PSP statement.' },
      ],
      status: 'paused',
      connectors: ['cnx_8002'],
